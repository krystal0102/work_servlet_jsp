...
<%@ page import="java.util.TreeMap" %>									<!-- servlet 대신해서 JSP에서 표현 -->
...
<body>
	 ...
	 <c:forEach var="i" begin="1" end="100" step="2">
 	 ...
 	 <h4>구구단: 4단</h4>
 	 <ul>
 	 	<!-- 변수i가 1에서 9까지 1씩증가 (step에 값이 없으면 1씩 증가) -->
 	 ...
 	 <h4>int형 배열</h4>
 	 	<!-- intArray[i] 값을 i에 저장해서 사용 / status는 for문의 상태. 상태값을 알아보기 위해 변수를 지정해줌 / count는 몇바퀴째인지~  -->
